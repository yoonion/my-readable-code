...
public class MinesweeperGame {
    ...
    public static final int RAND_MINE_COUNT = 10;
    public static final String FLAG_SIGN = "⚑";
    public static final String RAND_MINE_SIGN = "☼";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                System.out.println("프로그램에 의도치 않은 문제가 생겼습니다.");
            }
        }
    }
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        if (doesUserChooseToOpenCell(userActionInput)) {
            if (isLandMineCell(selectedRowIndex, selectedColIndex)) {
                BOARD[selectedRowIndex][selectedColIndex] = Cell.of(RAND_MINE_SIGN);
    ...
    private static void checkIsGameOver() {
    ...
    private static boolean isAllCellOpened() {
        return Arrays.stream(BOARD)
                ...
                .noneMatch(cell -> cell.equalsSign(CLOSED_CELL_SIGN)); // getter로 데이터를 꺼내는게 아니라, 객체에 메시지를 던지자.
    }
    ...
    private static void initializeGame() {
        ...
        for (int i = 0; i < RAND_MINE_COUNT; i++) {
